...
配置 iPhone 或 Android 前阅读 [references/mobile.md](references/mobile.md) 的中文版。
...
认证、网络或 VPN、重复笔记、冲突、监听失败和移动端限制请阅读 [references/troubleshooting.md](references/troubleshooting.md) 的中文版。
...
Read the English section in [references/mobile.md](references/mobile.md) before iPhone or Android setup.
...
Read the English section in [references/troubleshooting.md](references/troubleshooting.md) for authentication, network or VPN failures, duplicate notes, conflicts, watcher failures, and mobile limitations.
